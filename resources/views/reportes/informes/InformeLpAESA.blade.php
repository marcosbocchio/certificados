    ...
    <table class="tablamain">
        <tbody>
            ...
            <tr>
                ...
                <td class="col4">@if ($contratista && $contratista->formato_especial !== null)LP-{{ $contratista->formato_especial }}-{{ sprintf("%04d", $informe->numero) }}@else LP{{sprintf("%04d", $informe->numero)}}@endif</td>
            </tr>
        </tbody>
    </table>
    @else
    <table class="tablamain">
        <tbody>
            <tr>
                ...
                <td style="width:37mm">@if ($contratista && $contratista->formato_especial !== null)LP-{{ $contratista->formato_especial }}-{{ sprintf("%04d", $informe->numero) }}@else LP{{sprintf("%04d", $informe->numero)}}@endif</td>
