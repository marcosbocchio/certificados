...
<main>
    ...
    @foreach ($informes_us_me as $infome_us_me)   
            ...
            <table>
                <tbody>
                    <tr>
                         <td style="font-size: 14px;height:30px;"><span style="margin-left: 22px;">Elemento : {{ strtoupper($infome_us_me->elemento)}}</span><span style="margin-left: 10pxpx;">Ø : {{ $infome_us_me->diametro}}</span></td>  
                    </tr>
                </tbody>
            </table>            
