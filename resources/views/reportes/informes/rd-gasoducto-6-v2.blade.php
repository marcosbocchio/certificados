        ...
        <tbody>
            @foreach ($juntas_posiciones as $junta_posiciones)
                <tr>
                    ...
                    <td style="font-size: 11px;  width:51px;text-align: center" class="bordered-td">{{$ot_tipo_soldadura->TipoSoldadura->codigo}}</td>
                        ...
                        @foreach ($pasadas_juntas as $key => $pasadas_junta)
                            ...
                            @if (($pasadas_junta->junta_id == $junta_posiciones->id) && ($pasadas_junta->numero == 1 ))
                                 ...
                                 <td style="font-size: 11px;  width:36.5px; text-align:center;" class="bordered-td">{{$pasadas_junta->soldadorp}} </td>
                                  {{  $x = 1 }}
                    ...
                    <td style="font-size: 11px;width:21.5px; text-align: center" class="bordered-td">
                    ...
                    <!-- Resultado-->
                    <td style="font-size: 11px;width:25.7px; text-align: center; " class="bordered-td">
                        @if ($informe_rd->resultado_pdf_sn  && $junta_posiciones->aceptable_sn)
                            X
                        @endif
                    </td>
