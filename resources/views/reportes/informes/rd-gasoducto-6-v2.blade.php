...
<style>
    ...
    @page { margin: 245px 40px 280px 40px !important;
                ...
                <tr>
                    ...
                    @for ($numero = 1; $numero <= 6; $numero++)
                        ...
                        @foreach ($campos as $campo)
                            <td style="font-size: 11px; text-align: center" class="bordered-td">{{ $pasada->$campo ?? '' }}</td>
                        @endforeach
                    @endfor

                    <td style="font-size: 11px; text-align: center" class="bordered-td">{{ $junta_posicion->codigo }}</td>
