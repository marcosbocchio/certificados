                            ...
                            <tr>
                                <td style="text-align: center;">
                                    @if ($informe_modelos_3d[0]->path_imagen!=null)
                                        <img src="{{ public_path($informe_modelos_3d[0]->path_imagen) }}" alt="" height="145">
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        @if ($informe_modelos_3d[1]->path_imagen!=null)
                                            <img src="{{ public_path($informe_modelos_3d[1]->path_imagen) }}" alt="" height="145">
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            @if ($informe_modelos_3d[2]->path_imagen!=null)
                                                <img src="{{ public_path($informe_modelos_3d[2]->path_imagen) }}" alt="" height="145">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: center;">
                                            @if ($informe_modelos_3d[3]->path_imagen!=null)
                                                <img src="{{ public_path($informe_modelos_3d[3]->path_imagen) }}" alt="" height="145">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
