                    ...
                    <tbody>
                       ...
                       <tr>
                           <td colspan="4" style="padding:1px 4px 2px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                               ...
                               <div style="font-size:10px;font-style:italic;color:#1C2340;">{{$equipo->id}}</div>
                           </td>
                       </tr>
            ...
            <td width="49%">
                <table width="100%" style="border-collapse:collapse;float:right;">
                    <tbody>
                       ...
                       <tr>
                           <td colspan="4" style="padding:1px 4px 2px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                               <div style="font-size:7px;font-weight:bold;color:#4F8CFF;text-transform:uppercase;letter-spacing:0.3px;margin-bottom:0;">Estado de la Superficie</div>
                               <div style="font-size:10px;font-style:italic;color:#1C2340;">{{$informe_pmi->estado_superficie}}</div>
                           </td>
                       </tr>
