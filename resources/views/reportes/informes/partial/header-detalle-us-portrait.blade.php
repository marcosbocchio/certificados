                        ...
                        <tbody>
                           ...
                           <tr>
                               <td colspan="2" style="padding:1px 4px 2px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                                   <div style="font-size:7px;font-weight:bold;color:#4F8CFF;text-transform:uppercase;letter-spacing:0.3px;margin-bottom:0;">Encoder</div>
                                   <div style="font-size:10px;font-style:italic;color:#1C2340;">{{$informe_us->encoder}}</div>
                               </td>
                               <td colspan="2" style="padding:1px 4px 2px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                                   ...
                                   <div style="font-size:10px;font-style:italic;color:#1C2340;">{{$estado_superficie->codigo}}</div>
                               </td>
                           </tr>

                           <tr>
                               <td colspan="2" style="padding:1px 4px 2px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                                   <div style="font-size:7px;font-weight:bold;color:#4F8CFF;text-transform:uppercase;letter-spacing:0.3px;margin-bottom:0;">Agente Acoplamiento</div>
                                   <div style="font-size:10px;font-style:italic;color:#1C2340;">{{$agente_acoplamiento->codigo}}</div>
                               </td>
                               <td colspan="2" style="padding:1px 4px 2px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
