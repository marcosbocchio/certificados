                        ...
                        <tbody>
                           ...
                           <tr>
                               <td colspan="2" style="padding:4px 5px 5px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                                   <div style="font-size:8px;font-weight:bold;color:#4F8CFF;text-transform:uppercase;letter-spacing:0.3px;margin-bottom:2px;">Encoder</div>
                                   <div style="font-size:12px;font-style:italic;color:#1C2340;">{{$informe_us->encoder}}</div>
                               </td>
                               <td colspan="2" style="padding:4px 5px 5px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                                   ...
                                   <div style="font-size:12px;font-style:italic;color:#1C2340;">{{$estado_superficie->codigo}}</div>
                               </td>
                           </tr>

                           <tr>
                               <td colspan="2" style="padding:4px 5px 5px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
                                   <div style="font-size:8px;font-weight:bold;color:#4F8CFF;text-transform:uppercase;letter-spacing:0.3px;margin-bottom:2px;">Agente Acoplamiento</div>
                                   <div style="font-size:12px;font-style:italic;color:#1C2340;">{{$agente_acoplamiento->codigo}}</div>
                               </td>
                               <td colspan="2" style="padding:4px 5px 5px;border-bottom:1px solid #EEF2F7;vertical-align:top;">
