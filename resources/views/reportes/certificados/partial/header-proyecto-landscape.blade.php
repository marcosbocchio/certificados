<table width="100%" style="margin-top:10px">
    <tbody>
        <tr>
            ...
            <td width="16%" style="font-size: 12px;"><b>Obra </b></td>
            <td width="16%" style="font-size: 12px;"><b>OT N° </b></td>
            <td width="16%" style="font-size: 12px;"><b>FST N° </b></td>
        </tr>
        <tr>
            ...
            <td style="font-size: 12px;"><span class="datosHead"><span class="datosHead"></span>{{$ot->presupuesto}}</td>
        </tr>
    </tbody>
</table>
