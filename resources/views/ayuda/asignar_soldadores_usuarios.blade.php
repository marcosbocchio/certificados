...
<div class="ayuda_enod">
       <div class="row">
			<div class="col-sm-12">
			  ...
			  <p>Para que un usuario de cliente, tenga acceso a visualizar la OT , los informes, partes diarios y certificados, es necesario indicarlo explicitamente.<br> En el caso de que la OT tenga servicios de RI, tambien hay que indicar que soldadores serán posibles de seleccionar en este tipo de informes. Para poder seleccionarlos, éstos, previamente deben pertenecer al conjunto de <a href="{{ route('ayuda-gestion-soldadores') }}"><strong>soldadores informados</strong></a> por el cliente.<br> A continuación, se muestra un ejemplo de asignación de soldadores y usuarios de clientes a una OT: </p>
			 </div>
