       ...
       <div class="row">
        ...
        <div class="col-sm-12">
          <h3>Tablero Principal&nbsp;</h3>
			...
			<p><a href="{{ route('error-404') }}" target="_blank">Creación de remitos&nbsp;</a></p> <!-- CLIENTE NO VE  -->
        ...
        <div class="col-sm-12">
			...
			<p><a href="{{ route('error-404') }}" target="_blank">Gestionar interno equipos&nbsp;</a>
			</p>
		...
		<div class="col-sm-12">
          <h3>Dosimetría&nbsp;</h3>
			...
			<!-- CLIENTE NO VE  -->
			<p><a href="{{ route('error-404') }}" target="_blank">Como registrar dosimetría operador&nbsp;</a></p><!-- CLIENTE NO VE  -->
			<p><a href="{{ route('error-404') }}" target="_blank">Como registrar dosimetría RX&nbsp;</a></p><!-- CLIENTE NO VE  -->
			<p><a href="{{ route('error-404') }}" target="_blank">Gestionar estados film&nbsp;</a></p><!-- CLIENTE NO VE  -->
            <p><a href="{{ route('error-404') }}" target="_blank">Visualizar resumen dosimetría&nbsp;</a></p>
            <a name="-multimedia" />
			<p><a href="{{ route('error-404') }}" target="_blank">Visualizar reporte de altas y baja de film&nbsp;</a></p><!-- CLIENTE NO VE  -->
        </div>
