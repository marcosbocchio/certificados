                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        <tr v-for="(item,k) in TablaResumen" :key="k">
                                            ...
                                            <td bgcolor="#000000"  @click="getPeriodos(item.operador_id)">
                                                <popper trigger="click" :options="{placement: 'top'}">
                                                    ...
                                                    <a href="" slot="reference" class="top" @click.prevent :class="[{habilitadoArn : item.habilitado_arn_sn},{ deshabilitadoArn : !item.habilitado_arn_sn}]">
                                                    {{item.operador}}
                                                    </a>
                                                </popper>
                                             </td>
