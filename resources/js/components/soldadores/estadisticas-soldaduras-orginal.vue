                    ...
                    <tabs :options="{ useUrlFragment: false }" @clicked="tabClicked" @changed="tabChanged">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-lg-3" >
                                    ...
                                    <div class="col-lg-12">
                                        <div class="div-grafico">
                                            <div>
                                                <doughnut-chart id="sector2" :chart-data="data_defectologia" :options="data_defectologia.options" ></doughnut-chart>
                                            </div>
                                        </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-lg-10 col-lg-offset-1">
                                        <div style="max-height:350px;">
                                            <bar-chart id="sector3" :chart-data="data_detalle_defectos_soldador" :options="data_detalle_defectos_soldador.options" style="height: 400px;"  ></bar-chart>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tab name="Indicaciones">
                            <div v-if="TablaIndicaciones.length">
                                ...
                                <div class="col-lg-12">
                                    <div class="div-grafico">
                                        <doughnut-chart id="sector4" :chart-data="data_indicaciones_posicion" :options="data_indicaciones_posicion.options" ></doughnut-chart>
                                    </div>
                                </div>
                                <div class="col-lg-12 totales_posiciones">
                                    <div>
                            ...
                            <div v-if="TablaIndicacionesPosicionDetalle.length">
                                 <div class="row">
                                    <div class="col-lg-12">
                                        <div class="div-grafico">
                                            <div>
                                                <bar-chart id="sector4" :chart-data="data_indicaciones_posicion_detalle" :options="data_indicaciones_posicion_detalle.options" ></bar-chart>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
methods : {
    ...
    async downloadPdf_tab1 (){
        ...
        await html2canvas(document.getElementById('img_rechazos'),{ scale: 4 }).then(canvas => {

            var imgData = canvas.toDataURL('image/png')
            doc.addImage(imgData,'PNG',20,20,90,90)

        });

        doc.text("Análisis de rechazos por Diámetro", 14, 115)
     ...
     async downloadPdf_tab2 (){
        ...
        await html2canvas(document.querySelector("#sector2"),{ scale: 4 }).then(canvas => {

            var imgData = canvas.toDataURL('image/png',1.0)
            doc.addImage(imgData,'PNG',20,doc.lastAutoTable.finalY + 35,90,90)
    ...
    async downloadPdf_tab3(){
       ...
       doc.text("Soldador: " + this.soldador.codigo_soldador + " - " + this.soldador.nombre_soldador  , 14,doc.lastAutoTable.finalY + 14)
        ...
        await html2canvas(document.querySelector("#sector3"),{ scale: 4 }).then(canvas => {
    ...
    async downloadPdf_tab4 (){
        ...
        await html2canvas(document.querySelector("#sector4"),{ scale: 4 }).then(canvas => {
