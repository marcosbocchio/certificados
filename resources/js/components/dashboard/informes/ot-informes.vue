                            ...
                            <tbody>
                                <tr v-for="(ot_informe,k) in ot_informes.data" @click="selectPosTabla(k)" :key="k"  :class="{selected: indexPosTabla === k}">
                                    ...
                                    <td v-else width="10px">
                                        ...
                                        <td v-if="!ot_informe.importable_sn && (ot_informe.metodo == 'LP' || ot_informe.metodo == 'PM' || ot_informe.metodo == 'US'|| ot_informe.metodo == 'RI'|| ot_informe.metodo == 'RD'|| ot_informe.metodo == 'CV')" width="10px">
                                            <div class="dropdown">
