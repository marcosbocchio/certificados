       ...
       <div class="col-lg-3 col-xs-6">
         <a @click="EntrarCuadro('equipos')">
          <cuadro-enod
              ...
              :src_icono ="'/img/tablero/icono-empresa-equipos.svg'"
       ...
       <div class="col-lg-3 col-xs-6">
         <a @click="EntrarCuadro('documentaciones')">
          <cuadro-enod
              ...
              :src_icono ="'/img/tablero/icono-empresa-vehiculos-doc.svg'"
       ...
       <div class="col-lg-3 col-xs-6">
         <a @click="EntrarCuadro('informes')">
          <cuadro-enod
              ...
              :src_icono ="'/img/tablero/icono-empresa-informes.svg'"
       ...
       <div class="col-lg-3 col-xs-6">
         <a @click="EntrarCuadro('partes')">
          <cuadro-enod
              ...
              :src_icono ="'/img/tablero/icono-empresa-partes.svg'"
