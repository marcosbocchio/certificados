                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Formatos soportados : rdt,scn,ebwk .</p>
                             <div class="form-group">  
...
export default {
    ...
    onFileSelected(event) {         
            ...
            if((extension != '.rdt') || (extension != '.scn') || (extension != '.ebwk')){
            ...
            if(FileSize > 50 ){
                 ...
                 toastr.error('Archivo demasiado grande. (Max 50 MB)');
                 this.$refs.inputFile1.type = 'text';
                 this.$refs.inputFile1.type = 'file';  
                 this.selectedFile = null;
                 this.uploadPercentage = 0;
        ...
        onUpload() {
              ...
              let settings = { headers: { 'content-type': 'multipart/form-data' }, onUploadProgress: function( progressEvent ) {
               ...
               fd.append('archivos',this.selectedFile);
              
               axios.defaults.baseURL = this.url;     
               var url = 'storage/archivos_us';
               console.log(fd);
    ...
    updateRegistro: function(){
            ...
            axios.defaults.baseURL = this.url ;
            var urlRegistros = 'archivos_us/' + this.newRegistro.id;                  
