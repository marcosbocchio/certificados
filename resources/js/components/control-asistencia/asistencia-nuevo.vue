                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <v-select v-model="frente_selected" :options="frentes_opciones" label="codigo" id="frente"
                            @input="actualizarFechasBloqueadas"></v-select>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <table class="table table-hover table-striped table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th class="col-md-1 text-center" v-if="detalles.some(detalle => detalle.contratista)">
                                Técnica</th>
                    ...
                    <tbody>
                        <tr v-for="(detalle, index) in detalles" :key="index">
                            ...
                            <td>
                                <input type="text" v-model="detalle.parte" class="form-control text-center" />
                            </td>
                            <td class="text-center">
                                <v-select v-model="detalle.metodo_ensayo" :options="metodo_ensayos" label="metodo"
...
export default {
    ...
    methods: {
        ...
        async confirmar() {
            // --> AÑADIDO: Deshabilitar el botón y mostrar loader al inicio.
            this.isDis = true;
            this.isLoading = true;
            ...
            if (!this.frente_selected) {
                ...
                this.isDis = false; // --> AÑADIDO: Re-habilitar si hay error.
            ...
            // Si todo es válido, procedemos con la carga (isLoading ya es true)
            axios.post('/api/guardar_asistencia', {
                ...
                .then(response => {
                    ...
                    // En caso de éxito, el botón queda deshabilitado y se redirige. Perfecto.
                    window.location.href = '/area/enod/asistencia/servicios';
                })
                .catch(error => {
                    toastr.error('Error al guardar:', error);
                    this.isDis = false; // --> AÑADIDO: Re-habilitar si la API falla.
                })
                .finally(() => {
                    // --> CORREGIDO: Solo se necesita una línea.
                    this.isLoading = false;
                });
        },
