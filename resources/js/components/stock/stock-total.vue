        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="form-check form-check-inline mr-2">
                    <v-select v-model="selectedFilters" :options="filterOptions" label="text"
                        :reduce="option => option.value" multiple placeholder="Filtros" @input="getResults"></v-select>
                </div>
            </div>
