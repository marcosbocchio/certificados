                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="diametro" label="diametro" :options="diametros"
                                    @input="getEspesores()"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="metodo_trabajo_lp" :options="metodos_trabajo_lp" label="tipo_metodo"
                                    @input="getInstrumentoMediciones()">
                                    <template slot="option" slot-scope="option">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="tipo_penetrante" class="form-control" id="tipo_penetrante"
                                    disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div v-if="interno_equipo">
                                    <input type="text" v-model="interno_equipo.equipo.instrumento_medicion"
                                        class="form-control" id="instrumento_medicion" disabled>
                                </div>
                                <div v-else>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="penetrante_tipo_liquido" :options="penetrantes_tipo_liquido"
                                    label="tipo">
                                    <template slot="option" slot-scope="option">
                                        <span class="upSelect">{{ option.tipo }}</span> <br>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="penetrante_aplicacion" label="codigo"
                                    :options="aplicaciones_lp"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="tiempo_penetracion" class="form-control"
                                    id="tiempo_penetracion">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="revelador_tipo_liquido" :options="reveladores_tipo_liquido"
                                    label="tipo">
                                    <template slot="option" slot-scope="option">
                                        <span class="upSelect">{{ option.tipo }}</span> <br>
                                        <span class="downSelect"> {{ option.marca }} </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="revelador_aplicacion" label="codigo"
                                    :options="aplicaciones_lp"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="removedor_tipo_liquido" :options="removedores_tipo_liquido"
                                    label="tipo">
                                    <template slot="option" slot-scope="option">
                                        <span class="upSelect">{{ option.tipo }}</span> <br>
                                        <span class="downSelect"> {{ option.marca }} </span>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="removedor_aplicacion" label="codigo"
                                    :options="aplicaciones_lp"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="limpieza_intermedia" class="form-control"
                                    id="limpieza_intermedia">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="iluminacion" label="codigo" :options="iluminaciones"
                                    disabled></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="temperatura_superficial" class="form-control"
                                    id="temperatura_superficial" step="0.1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="temperatura_consumibles" class="form-control"
                                    id="temperatura_consumibles" step="0.1">
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="termostato" class="form-control" id="termostato"
                                    placeholder="FLUKE 572-2">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in (TablaLp)" :key="k" @click="selectPosDetalle(k)"
                                                ...
                                                <td>
                                                    <div v-if="indexPosDetalle == k">
                                                        <input type="text" v-model="TablaLp[k].detalle" maxlength="50"
                                                            size="100%">
                                                    </div>
                                                    <div v-else>
                                                        {{ TablaLp[k].detalle }}
                                                ...
                                                <td style="text-align:center">
                                                    <input type="checkbox" id="checkbox"
                                                        v-model="TablaLp[k].aceptable_sn">
                                                </td>
                                                <td style="text-align:center">
                                                    <span :class="{
                                                        ...
                                                        @click="OpenReferencias($event, k, 'Informe PM', item)"></span>
                                                </td>
