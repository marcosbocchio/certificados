                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="planta" v-model="planta" class="form-control"
                                                disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="area" v-model="area" maxlength="20"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="nEquipo" v-model="nEquipo" class="form-control"
                                                disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <subir-imagen :ruta="ruta_componente_us" :max_size="max_size"
                                            :path_inicial="path3_componente"
                                            :tipos_archivo_soportados="tipos_archivo_soportados"
                                            :mostrar_formatos_soportados="true" @path="onPath"></subir-imagen>
                                    </div>
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group d-flex">
                                            <label>Modelo *</label>
                                            <v-select v-model="modelo" label="codigo" :options="modeloOptions" taggable>
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="denominacion" v-model="denominacion" maxlength="30"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="anio" v-model="anio" min="0" max="9999"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="detalleDescripcion" v-model="detalle.descripcion"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <v-select v-model="detalle.material" :options="materialesOpcion"
                                                label="codigo" :input-id="'detalleMaterial'" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="detalleGrado">Grado</label>
                                            <input type="number" id="detalleGrado" v-model="detalle.grado" min="0"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="detalleEspNominal" v-model="detalle.espNominal"
                                                min="0" max="9999" class="form-control" :disabled="tipo === 'Linea'">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="detalleEspMinMedido">Esp. Min Medido</label>
                                            <input type="number" id="detalleEspMinMedido" v-model="detalle.espMinMedido"
                                                min="0" max="9999" class="form-control" :disabled="tipo === 'Linea'">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="temp.disenio" min="0" max="9999" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="temp.operacion" min="0" max="9999" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="pres.disenio" min="0" max="9999" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="pres.operacion" min="0" max="9999" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group d-flex">
                                            <label>Fluido * </label>
                                            <v-select v-model="fluido" :options="fluidoOptions" label="codigo" taggable>
                                                <template slot="option" slot-scope="option">
                                                    <span class="upSelect">{{ option.codigo }}</span><br>
                                                    <span class="downSelect">{{ option.descripcion }}</span>
                                                </template>
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="sobreespesor" min="0" max="9999" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="diamExterior" min="0" max="99999999"
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="longitudTotal" min="0" max="99999999"
                                                step="0.01" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <input type="number" v-model="radiografiado" min="1" max="100" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <v-select :options="normaFabricacionOptions" label="codigo"
                                                v-model="normaFabricacion">
                                                <template slot="option" slot-scope="option">
                                                    <span class="upSelect">{{ option.codigo }}</span><br>
                                                    <span class="downSelect">{{ option.descripcion }}</span>
                                                </template>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <v-select :options="siNoOptions" v-model="aislacion"
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group d-flex">
                                            <label>Tipo</label>
                                            <v-select v-model="tipo2" :options="tipo2Options" label="codigo" taggable>
                                                <template slot="option" slot-scope="option">
                                                    <span class="upSelect">{{ option.codigo }}</span><br>
                                                    <span class="downSelect">{{ option.descripcion }}</span>
                                                </template>
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            ...
                                            <v-select :options="materialOptions" v-model="material" label="codigo"
                                    ...
                                    <div class="col-md-3" v-if="tipo !== 'Linea'">
                                        <div class="form-group">
                                            <label>Espesor</label>
                                            <input type="text" v-model="espesor" placeholder="Espesor" step="0.01"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
