    ...
    <div class="row">
        <div class="col-md-12">
            <form @submit.prevent="editmode ? Update() : Store()" method="post">
                <informe-header :otdata="otdata" :deshabilitarPlanta_sn="isGasoducto" :informe_id="informedata.id"
                    :editmode="editmode" @set-obra="setObra" @set-planta="setPlanta"
                    ref="informeHeader"></informe-header>
                    ...
                    <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <date-picker v-model="fecha" value-type="YYYY-MM-DD" format="DD-MM-YYYY"
                                        placeholder="DD-MM-YYYY" autocomplete="new-password"></date-picker>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3" v-if="formato == 'DUCTO'">
                                    <div class="form-group">
                                        ...
                                        <input type="number" v-model="pk" class="form-control" id="pk"
                                            :disabled="((!isGasoducto) || reparacion_sn == true || reparacion_sn == 1)"
                                            min="-1">
                                    </div>
                                </div>
                                ...
                                <div v-if="isGasoducto">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <!-- Checkbox para "R" -->
                                            <input type="checkbox" id="reparacion_sn" v-model="reparacion_sn"
                                                :disabled="!pk || !tipo_soldadura" @change="cambioReparacion_sn()"
                                                style="float:right">
                                            <label for="reparacion_sn" style="float:right;margin-right: 5px;">R</label>

                                            <!-- v-select con opciones personalizadas -->
                                            <v-select v-model="tipo_soldadura" label="codigo"
                                                :options="ot_tipo_soldaduras_filter_R" id="ot_obra_tipo_soldaduras"
                                ...
                                <div v-else>
                                    <div class="col-md-3">
                                        <label for="reparacion_sn" v-if="formato == 'PLANTA'"
                                            style="display:block">&nbsp;</label>
                                        <input type="checkbox" id="reparacion_sn" style="float:left;margin-right: 5px;"
                                            v-model="reparacion_sn" @change="cambioReparacion_sn()" :disabled="!obra"
                                            v-if="formato == 'PLANTA'">
                                    ...
                                    <div class="col-md-3">
                                        <label for="reparacion_sn" v-if="formato == 'PLANTA'"
                                            style="display:block">&nbsp;</label>
                                        <input type="checkbox" id="ptt_sn" style="float:left;margin-right: 5px;"
                                            :checked="ptt_sn" @click="cambioPtt_sn()" :disabled="!obra"
                                            v-if="formato === 'PLANTA'">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="numero_inf_code" class="form-control"
                                            id="numero_inf" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="procedimiento" label="titulo" :options="procedimientos"
                                    id="procRadio" :appendToBody="appendToBody" :autoscroll="true"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="linea" @change="getElementosReparacion" class="form-control"
                                    id="linea" maxlength="30">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="plano_isom" class="form-control" id="plano_isom"
                                    @change="getElementosReparacion" maxlength="30">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="hoja" class="form-control" id="hoja"
                                    @change="getElementosReparacion" maxlength="10">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="diametro" label="diametro" :options="diametros" taggable
                                    @input="changeDiametro(diametro)"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="espesor" label="espesor" :options="espesores" taggable
                                    :disabled="isChapa" @input="cambioEspesor()">
                        ...
                        <div v-if="!reparacion_sn" class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="ot_tipo_soldadura" label="eps"
                                    :options="ot_tipo_soldaduras_filter_codigo"
                        ...
                        <div v-else class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="ot_tipo_soldadura" label="proc_reparacion"
                                    :options="ot_tipo_soldaduras_filter_codigo"
                                    id="procedimientos_soldadura"></v-select>
                            </div>
                        </div>
                        ...
                        <div v-if="!reparacion_sn" class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="ot_tipo_soldadura" label="pqr"
                                    :options="ot_tipo_soldaduras_filter_codigo" id="pqr"></v-select>
                            </div>
                        </div>
                        ...
                        <div v-if="(fuente)" class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="interno_fuente.foco" class="form-control" id="foco"
                                    disabled>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <v-select v-model="ejecutor_ensayo" label="name"
                                            :options="ejecutor_ensayos"></v-select>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="N_Reporte_RFI" class="form-control"
                                            id="N_Reporte_RFI" maxlength="30">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="sistema_aesa" class="form-control" id="sistema_aesa"
                                            maxlength="20">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="elemento_aesa" class="form-control"
                                            id="elemento_aesa" maxlength="20">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" v-model="paq_de_prueba_aesa" class="form-control"
                                            id="paq_de_prueba_aesa" maxlength="20">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box box-custom-enod" v-if="formato != 'PERFILES'">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            <p>&nbsp;</p>
                            <button type="button" @click="AddDetalle()" title="Agregar Junta/Posición"><app-icon
                                        ...
                                        <tbody>
                                            <template v-for="(FIlaTabla, k) in (TablaDetalle)">
                                                <tr :key="k" :class="{ selected: indexDetalle === k }" class="pointer">
                                                    ...
                                                    <td @click="selectPosDetalle(k)">
                                                        <div v-if="indexDetalle == k">
                                                            <input type="text" v-model="TablaDetalle[k].observacion"
                                                    ...
                                                    <td> <a @click="RemoveDetalle(k)"> <app-icon img="minus-circle"
                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <v-select v-model="defectoRiPlanta"
                                                                            :options="defectosRiPlanta" label="codigo"
                                                                            :disabled="(!TablaDetalle.length)">
                                                                            <template slot="option" slot-scope="option">
                                                                                <span class="upSelect">{{
                                                                                    option.descripcion }} </span> <br>
                                                                ...
                                                                <div class="col-md-2">
                                                                    <div class="form-group">
                                                                        <label for="posicionPlacaGosaducto">Pos.
                                                                            Indicación</label>
                                                                        <input type="text"
                                                                            v-model="posicionPlacaGosaducto"
                                                                            class="form-control"
                                                                ...
                                                                <div v-if="formato == 'DUCTO'" class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <v-select v-model="defecto_sector"
                                                                            label="defecto_sector"
                                                                            :options="['RAIZ', 'RELLENO', 'SOBREMONTA']"
                                                                            id="defecto_sector"
                                                                            :disabled="(!posicionPlacaGosaducto)"></v-select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-1">
                                                                    <div class="form-group">
                                                                        <p>&nbsp;</p>
                                                                        <span>
                                                                            <button type="button" @click="addDefectos()"
                                                                                title="Agregar Defecto"><app-icon
                                                                                    img="plus-circle"
                                                                                    color="black"></app-icon></button>
                                                                        </span>
                                                                    </div>
                                                                ...
                                                                <div
                                                                    v-if="TablaDetalle.length && TablaDetalle[indexDetalle].defectos.length">
                                                                    <div class="col-md-8">
                                                                        <div class="table-responsive">
                                                                            <table
                                                                                ...
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th class="col-md-6">Descripción
                                                                                        </th>
                                                                                        <th class="col-md-2">Posición
                                                                                        </th>
                                                                                        <th v-if="formato == 'DUCTO'"
                                                                                            class="col-md-2">Sector</th>
                                                                                        <th>&nbsp;</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                    <tr v-for="(defectoPasada, k) in ((TablaDetalle.length > 0) ? TablaDetalle[indexDetalle].defectos : [])"
                                                                                        :key="k">
                                                                                        ...
                                                                                        <td v-if="formato == 'DUCTO'">{{
                                                                                            defectoPasada.pasada }}</td>
                                                                                        <td class="pointer">
                                                                                            <a
                                                                                                @click="RemoveDefectos(k)">
                                                                                                <app-icon
                                                                                                    img="minus-circle"
                                                                                                    color="black"></app-icon>
                                                                                            </a>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="bola_comparadora" class="form-control"
                                    id="bola_comparadora" step=".01" min="0.01">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="espesor">Espesor</label>
                                <input type="number" v-model="espesor_tramo" class="form-control" id="espesor_tramo"
                                    step=".01" min="0.01">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="observacion_tramo" class="form-control"
                                    id="observacion_tramo" maxlength="100">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <p>&nbsp;</p>
                            <span>
                                <button type="button" @click="AddTramos()" title="Agregar Pasada"><app-icon
                                        img="plus-circle" color="black"></app-icon></button>
                            </span>
                        </div>
                            ...
                            <div class="col-md-11">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(tramos, k) in ((TablaTramos.length > 0) ? TablaTramos : [])"
                                                :key="k">
                                                <td>{{ tramos.tramo }}</td>
                                                ...
                                                <td v-else-if="k != 0">&nbsp;</td>
                                                <td class="pointer">
                                                    <a @click="RemoveTramos(k)"> <app-icon img="minus-circle"
                                                            color="black"></app-icon>
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <v-select v-model="elemento_pasada" :options="elemento_pasadas"
                                    @input="autocompletarNumeroPasada" id="elemento_pasadas"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            ...
                            <v-select v-model="soldador3" :options="soldadores" label="codigo"
                                :disabled="(!TablaDetalle.length)">
                                <template slot="option" slot-scope="option">
                        ...
                        <div v-if="isGasoducto">
                            <div class="col-md-2">
                                ...
                                <v-select v-model="soldador2" :options="soldadores" label="codigo"
                                    :disabled="(!isGasoducto || pasada != '1' || !TablaDetalle.length)">
                                    <template slot="option" slot-scope="option">
                                        <span class="upSelect">{{ option.nombre }} </span> <br>
                                        <span class="downSelect"> {{ option.codigo }} </span>
                                    </template>
                        ...
                        <div class="col-md-2">
                            ...
                            <label>Cuño Z</label>
                            <v-select v-model="soldador1" :options="soldadores" label="codigo"
                                :disabled="(!TablaDetalle.length)">
                                <template slot="option" slot-scope="option">
                                    <span class="upSelect">{{ option.nombre }} </span> <br>
                                    <span class="downSelect"> {{ option.codigo }} </span>
                        ...
                        <div class="col-md-2" v-if="formato == 'PLANTA'">
                            <div class="form-group">
                                ...
                                <v-select v-model="proceso_soldadores"
                                    :options="['GMAW', 'GTAW', 'SAW', 'SMAW', 'FCAW']"></v-select>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <p>&nbsp;</p>
                            <span>
                                <button type="button" @click="AddPasadas()" title="Agregar Pasada"><app-icon
                                        img="plus-circle" color="black"></app-icon></button>
                                <button type="button" @click="ModalClonarSoldadores()"
                                    title="Clonar Soldadores"><app-icon img="clone" color="black"></app-icon></button>
                                <button type="button" @click="ModalImportarSoldadores()" :disabled="(!isGasoducto)"
                                    title="Importar Soldadores"><app-icon img="file-excel-o"
                                        color="black"></app-icon></button>
                                <button type="button" @click="getSoldadores()" title="Recargar Cuños"><app-icon
                                        img="refresh" color="black"></app-icon></button>
                            </span>
                        </div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(Pasada, k) in (TablaPasadas)" :key="k"
                                                @click="selectPosPasadas(k)" class="pointer">
                                                <td v-if="Pasada.elemento_pasada == elemento_pasada">{{
                                                    Pasada.elemento_pasada }}</td>
                                                <td v-if="Pasada.elemento_pasada == elemento_pasada">{{ Pasada.pasada }}
                                                </td>
                                                <td v-if="Pasada.elemento_pasada == elemento_pasada">
                                                    <div v-if="indexPasada == k">
                                                        <v-select v-model="TablaPasadas[indexPasada].soldador3"
                                                            :options="soldadores" label="codigo">
                                                            <template slot="option" slot-scope="option">
                                                                <span class="upSelect">{{ option.nombre }} </span> <br>
                                                                <span class="downSelect"> {{ option.codigo }} </span>
                                                            </template>
                                                ...
                                                <td v-if="Pasada.elemento_pasada == elemento_pasada">
                                                    <div v-if="indexPasada == k">
                                                        <v-select v-model="TablaPasadas[indexPasada].soldador2"
                                                            :options="soldadores" label="codigo"
                                                            :disabled="(!isGasoducto || TablaPasadas[indexPasada].pasada != '1' || !TablaDetalle.length)">
                                                            <template slot="option" slot-scope="option">
                                                                <span class="upSelect">{{ option.nombre }} </span> <br>
                                                                <span class="downSelect"> {{ option.codigo }} </span>
                                                            </template>
                                                ...
                                                <td v-if="Pasada.elemento_pasada == elemento_pasada">
                                                    <div v-if="indexPasada == k">
                                                        <v-select v-model="TablaPasadas[indexPasada].soldador1"
                                                            :options="soldadores" label="codigo">
                                                            <template slot="option" slot-scope="option">
                                                                <span class="upSelect">{{ option.nombre }} </span> <br>
                                                                <span class="downSelect"> {{ option.codigo }} </span>
                                                ...
                                                <td
                                                    v-if="Pasada.elemento_pasada == elemento_pasada && formato == 'PLANTA'">
                                                    <div v-if="indexPasada == k">
                                                        <v-select v-model="TablaPasadas[indexPasada].proceso_soldadores"
                                                            :options="['GMAW', 'GTAW', 'SAW', 'SMAW']"
                                                            :disabled="(!isGasoducto || pasada != '1' || !TablaDetalle.length)"></v-select>
                                                    </div>
                                                    <div v-else>
                                                ...
                                                <td v-if="Pasada.elemento_pasada == elemento_pasada">
                                                    <a @click="RemovePasada(k)"> <app-icon img="minus-circle"
                                                            color="black"></app-icon>
                                                    </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <input type="checkbox" id="sel_todos" v-model="sel_todos_clonar"
                                            @click="SeleccionarTodosClonar" style="float:left">
                                        <label for="sel_todos" style="float:left;margin-left: 5px;">Seleccionar
                                            Todos</label>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="modal fade " tabindex="-1" role="dialog" id="modal-Importar-Soldadores" data-keyboard="false"
                data-backdrop="static">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
...
.tabla-detalle tr:nth-child(4n+1),
.tabla-detalle tr:nth-child(4n+2) {
    background: #f2f2f2;
}
</style>
