            ...
            <form @submit.prevent="editmode ? Update() : Store()" method="post">
                ...
                <div class="box box-custom-enod">
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="procRadio">Procedimiento RD *</label>
    ...
    methods: {
        setEdit: function () {
            if (this.editmode) {
                ...
                this.formato = this.informe_rddata.gasoducto_sn ? 'DUCTO' : (this.informe_rddata.perfil_sn ? 'PERFILES' : 'PLANTA');
                ...
                this.kv = this.informe_rddata.kv;
                this.ma = this.informe_rddata.ma;
                ...
                this.$store.dispatch('loadOtObraTipoSoldaduras', { 'ot_id': this.otdata.id, 'obra': this.informedata.obra }).then(res => {
                    ...
                    this.reparacion_sn = this.informe_rddata.reparacion_sn == 1 ? true : false;
        ...
        getDefectosRdPlanta: function () {
            axios.defaults.baseURL = this.url;
            var urlRegistros = 'defectos_rd/planta/' + '?api_token=' + Laravel.user.api_token;
            axios.get(urlRegistros).then(response => {
                this.defectosRiPlanta = response.data
            }).finally(res => { this.$store.commit('loading', false); });

        },
        getDefectosRdGasoducto: function () {
            axios.defaults.baseURL = this.url;
            var urlRegistros = 'defectos_rd/gasoducto/' + '?api_token=' + Laravel.user.api_token;
            axios.get(urlRegistros).then(response => {
        ...
        Store: async function (forzar = false) {
            ...
            axios({
                ...
                window.open('/pdf/informe/rd/' + informe.id, '_blank');
        ...
        Update: async function (forzar = false) {
            ...
            if (this.formato == 'PERFILES')
                ...
                perfil_sn = null;
            var urlRegistros = 'informes_rd/' + this.informedata.id;
            this.$store.commit('loading', true);
            axios({
                method: 'put',
                url: urlRegistros,
