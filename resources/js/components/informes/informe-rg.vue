                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="recorrido_terminal" class="form-control" min="0"
                                    step="0.1">
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-6">
                                        <input type="number" v-model="rango_inicial" class="form-control" step="0.01"
                                            min="0">
                                    </div>
                                    <div class="col-md-6 col-xs-6">
                                        <input type="number" v-model="rango_final" class="form-control" step="0.01"
                                            min="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4 col-xs-3">
                                        <label>&nbsp;</label>
                                        <input type="number" v-model="ra_a" class="form-control" step="0.01" min="0"
                                            placeholder="A">
                                    </div>
                                    <div class="col-md-4 col-xs-3">
                                        <label class="centrado-label">Ra (µm) </label>
                                        <input type="number" v-model="ra_b" class="form-control" step="0.01" min="0"
                                            placeholder="B">
                                    </div>
                                    <label>&nbsp;</label>
                                    <div class="col-md-4 col-xs-3">
                                        <input type="number" v-model="ra_c" class="form-control" step="0.01" min="0"
                                            placeholder="C">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in (TablaRg)" :key="k"
                                                ...
                                                <td style="text-align:center">
                                                    <span :class="{
                                                        ...
                                                        @click="OpenReferencias($event, k, 'Informe CV', item)"></span>
                                                </td>
