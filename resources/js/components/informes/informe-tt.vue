    ...
    <div class="row">
        <div class="col-md-12">
            <form @submit.prevent="editmode ? Update() : Store()" method="post">
                <informe-header :otdata="otdata" :informe_id="informe_id" :editmode="editmode"
                    ...
                    <div class="box-body">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div>
                                    <date-picker v-model="dataForm.fecha" value-type="YYYY-MM-DD" format="DD-MM-YYYY"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="dataForm.componente" class="form-control" id="componente"
                                    maxlength="30">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="dataForm.material" label="codigo" :options="materiales"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="radio" id="caño" value="Caño" v-model="dataForm.material2_tipo"
                                    style="float:right">
                                <label for="caño" style="float:right;margin-right: 5px;margin-left:5px"
                                    title="Caño">Caño</label>
                                <input type="radio" id="accesorio" value="Accesorio" v-model="dataForm.material2_tipo"
                                    style="float:right">
                                <label for="accesorio" style="float:right;margin-right: 5px;margin-left:5px"
                                    title="Accesorio">Acces.</label>
                                <v-select v-model="dataForm.material2" label="codigo" :options="materiales"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="dataForm.procedimiento" label="titulo" :options="procedimientos"
                                    id="procRadio" :appendToBody="false" :autoscroll="true"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="dataForm.linea" class="form-control" id="linea"
                                    maxlength="30">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="dataForm.plano_isom" class="form-control" id="plano_isom"
                                    maxlength="30">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="dataForm.hoja" class="form-control" id="hoja"
                                    maxlength="10">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="dataForm.ot_tipo_soldadura" label="eps"
                                    :options="ot_obra_tipo_soldaduras" id="procedimientos_soldadura"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="dataForm.ot_tipo_soldadura" label="pqr"
                                    :options="ot_obra_tipo_soldaduras" id="pqr"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Equipo *</label>
                                <v-select v-model="dataForm.interno_equipo" :options="interno_equipos"
                                    label="nro_interno">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="dataForm.temperatura_inicial" @input="generarGrafico"
                                    class="form-control" id="temperatura_inicial" step="0.1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="dataForm.temperatura_subida" @input="generarGrafico"
                                    class="form-control" id="temperatura_subida" step="0.1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="dataForm.temperatura_mantenimiento"
                                    @input="generarGrafico" class="form-control" id="temperatura_mantenimiento"
                                    step="0.1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="dataForm.temperatura_enfriado" @input="generarGrafico"
                                    class="form-control" id="temperatura_enfriado" step="0.1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" v-model="dataForm.temperatura_final" @input="generarGrafico"
                                    class="form-control" id="temperatura_final" step="0.1">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="dataForm.norma_evaluacion" label="codigo"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="dataForm.ejecutor_ensayo" label="name"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="dataForm.solicitado_por" label="name"
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <line-chart :chart-data="data_indicaciones_temperatura"
                                :options="data_indicaciones_temperatura.options" :chart-id="'img_temp'"></line-chart>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="elemento" class="form-control" id="elemento"
                                        maxlength="30">
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                <tr v-for="(item, k) in (dataForm.detalle)" :key="k"
                                                    @click="selectPosDetalle(k)"
                    ...
                    <div class="box box-custom-enod">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <textarea v-model="dataForm.observaciones" class="form-control noresize" rows="3"
