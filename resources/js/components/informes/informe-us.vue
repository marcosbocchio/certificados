<template>
    <div class="row">
        ...
        <ModalPopup ref="modalPopupRef" :is-open="isModalOpen"
            :plantaProp="typeof planta === 'string' ? { codigo: planta } : (planta || {})" :nEquipoProp="componente"
            :materialesProp="materiales" :material_selected="(material && typeof material === 'object') ? material : {}"
            :otdataProp="otdata" :tipo_tgs="tipo_tgs" @close="closeModal" @submit="handleModalSubmit" />
        <div class="col-md-12">
            <form @submit.prevent="editmode ? Update() : Store()" method="post">
                <informe-header :otdata="otdata" :informe_id="informedata.id" :editmode="editmode"
                    @set-obra="setObra($event)" @set-planta="setPlanta($event)"></informe-header>
                    ...
                    <div class="box-body">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div>
                                    <date-picker v-model="fecha" value-type="YYYY-MM-DD" format="DD-MM-YYYY"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="componente">
                                    Componente *
                                    <button type="button" @click="openModal" v-if="
                                        pdfEspecialsn
                                        && tecnica?.codigo === 'ME'
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="material" label="codigo" :options="materiales"
                                    :input-id="'material'"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label for="caño" style="float:right;margin-right: 5px;margin-left:5px"
                                    title="Caño">Caño</label>
                                <input type="radio" id="accesorio" value="Accesorio" v-model="material2_tipo"
                                    style="float:right">
                                <label for="accesorio" style="float:right;margin-right: 5px;margin-left:5px"
                                    title="Accesorio">Acces.</label>
                                <v-select v-model="material2" label="codigo" :options="materiales"
                                    id="material2"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="diametro" label="diametro" :options="diametros" taggable
                                    @input="getEspesores(diametro)"></v-select>
                            </div>
                        </div>
                        ...
                        <div v-else>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Espesor</label>
                                    <v-select v-model="espesor" label="espesor" :options="espesores" taggable
                                        :disabled="isChapa || isVarios">
                        ...
                        <div class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="ot_tipo_soldadura" label="eps" :options="ot_obra_tipo_soldaduras"
                                    id="procedimientos_soldadura"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group size-pqr-eps">
                                ...
                                <v-select v-model="ot_tipo_soldadura" label="pqr" :options="ot_obra_tipo_soldaduras"
                                    id="pqr"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="tecnica" label="descripcion" :options="tecnicas" id="tecnicas"
                                    @input="resetTecnica"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select id="tipo" :options="tipoOptions" v-model="tipo_tgs"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="procedimiento" label="titulo" :options="procedimientos"
                                    id="procRadio"></v-select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="estado_superficie" label="codigo"
                                    :options="estados_superficies"></v-select>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                        <div class="col-md-3">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select v-model="modelo_3d" label="codigo" :options="modelos_3d"
                                    id="modelos_3d"></v-select>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in (TablaModelos3d)" :key="k">
                                                ...
                                                <td>
                                                    <a @click="RemoveModelo(k)"> <app-icon img="minus-circle"
                                                            color="black"></app-icon>
                                                    </a>
                                                </td>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="angulo_apertura" class="form-control"
                                        id="angulo_apertura">
                                </div>
                            </div>
                            ...
                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    <label for="block_sensibilidad" title="Block Sensibilidad">Block Sensibilidad
                                        *</label>
                                    <input type="number" v-model="block_sensibilidad" class="form-control"
                                        id="block_sensibilidad">
                                </div>
                            </div>
                            ...
                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    <label for="reflector_referencia" title="Reflector Referencia (mm)">Reflector
                                        Referencia (mm)
                                        *</label>
                                    <input type="number" v-model="reflector_referencia" class="form-control"
                                        id="reflector_referencia" step="0.1">
                                </div>
                            </div>

                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    <label for="ganancia_referencia" title="Ganancia Referencia (dB)">Ganancia
                                        Referencia (dB) *</label>
                                    <input type="number" v-model="ganancia_referencia" class="form-control"
                                        id="ganancia_referencia">
                                </div>
                            </div>
                            ...
                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="nivel_registro" class="form-control"
                                        id="nivel_registro">
                                </div>
                            </div>
                            ...
                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    <label for="correccion_transferencia"
                                        title="Corrección Transferencia (dB)">Corrección Transferencia
                                        (dB) *</label>
                                    <input type="number" v-model="correccion_transferencia" class="form-control"
                                        id="correccion_transferencia">
                                </div>
                            </div>

                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    <label for="adicional_barrido" title="Adicional Barrido (dB)">Adicional Barrido (dB)
                                        *</label>
                                    <input type="number" v-model="adicional_barrido" class="form-control"
                                        id="adicional_barrido">
                                </div>
                            </div>

                            <div v-show="tecnica.codigo != 'ME'" class="col-md-3">
                                <div class="form-group">
                                    <label for="amplificacion_total" title="Amplificación Total (dB)">Amplificación
                                        Total (dB) *</label>
                                    <input type="number" v-model="amplificacion_total" class="form-control"
                                        id="amplificacion_total">
                                </div>
                            </div>
                                        ...
                                        <table class="table table-hover table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                <tr v-for="(calibracion, k) in (calibraciones)" :key="k">
                                                    ...
                                                    <td>
                                                        <a @click="removeCalibraciones(k)"> <app-icon img="minus-circle"
                                                                color="black"></app-icon> </a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_calibraciones_us" :max_size="max_size"
                                    ...
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path2_calibracion = $event"></subir-imagen>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_calibraciones_us" :max_size="max_size"
                                    ...
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path3_calibracion = $event"></subir-imagen>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_calibraciones_us" :max_size="max_size"
                                    ...
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path4_calibracion = $event"></subir-imagen>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <v-select v-model="diametro_us_pa" label="diametro" :options="diametros" taggable
                                        id="diametro_us_pa"></v-select>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="nro_indicacion_us_pa" class="form-control"
                                        id="nro_indicacion_us_pa">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="barrido_up_pa" title="Barrido">Barrido *</label>
                                    <input type="text" v-model="barrido_us_pa" class="form-control" id="barrido_us_pa"
                                        maxlength="3">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" v-model="posicion_examen_us_pa" class="form-control"
                                        id="posicion_examen_up_pa">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="angulo_incidencia_us_pa" title="Ángulo Incidencia">Ángulo Incidencia
                                        *</label>
                                    <input type="text" v-model="angulo_incidencia_us_pa" class="form-control"
                                        id="angulo_incidencia_us_pa">
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="camino_sonico_us_pa" class="form-control"
                                        id="camino_sonico_us_pa" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="longitud_us_pa" class="form-control"
                                        id="longitud_us_pa" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="nivel_registro_us_pa" title="Nivel Registro">Nivel Registro *</label>
                                    <input type="number" v-model="nivel_registro_us_pa" class="form-control"
                                        id="nivel_registro_us_pa" step="0.01">
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-striped table-bordered table-condensed">
                                            ...
                                            <tbody>
                                                <tr v-for="(item, k) in (Tabla_us_pa)" :key="k"
                                                    @click="selectPosTabla_us_pa(k)"
                                                    :class="{ selected: indexPosTabla_us_pa === k }">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="checkbox"
                                                            v-model="Tabla_us_pa[k].aceptable_sn_us_pa">
                                                    </td>
                                                    <td>
                                                        <span :class="{
                                                            existe: (item.observaciones ||
                                                                item.path1 ||
                                                                item.path2 ||
                                                                item.path3 ||
                                                                item.path4)
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="umbral_me" class="form-control" id="umbral_me" min="0"
                                        step="0.1">
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="espesor_minimo_me" class="form-control"
                                        id="espesor_minimo_me" min="0" step="0.1">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="espesor_minimo_anterior_me" title="Espesor minimo anterior">Espesor
                                        minimo anterior
                                        <span v-if="pdfEspecialsn">*</span>
                                    </label>
                                    <input type="number" v-model="espesor_minimo_anterior_me" class="form-control"
                                        id="espesor_minimo_anterior_me" min="0" step="0.1">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="años_ultima_inspeccion_me" class="text-nowrap"
                                        title="Años desde la última inspección">Años desde la última inspección
                                        <span v-if="pdfEspecialsn">*</span>
                                    </label>
                                    <input type="number" v-model="años_ultima_inspeccion_me" class="form-control"
                                        id="años_ultima_inspeccion_me" min="0" step="0.1">
                                </div>
                            </div>

                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="cantidad_generatrices_linea_pdf_me"
                                        title="Cantidad Generatrices por linea en informe">Generatrices por Linea en pdf
                                        *</label>
                                    <input type="number" v-model="cantidad_generatrices_linea_pdf_me"
                                        class="form-control" id="cantidad_generatrices_linea_pdf_me" min="1" max="30">
                                </div>
                            </div>
                            ...
                            <div class="col-md-10">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in (Tabla_me)" :key="k" @click="selectPosTabla_me(k)"
                                                class="pointer" :class="{ selected: indexPosTabla_me === k }">
                                                <td>{{ item.elemento_me }}</td>
                                                <td>
                                                    <input type="number" v-model="item.umbral_me" min="1" max="30"
                                                        step="0.1">
                                                </td>
                                                <td>
                                                    <input type="number" v-model="item.espesor_minimo_me" min="1"
                                                        max="30" step="0.1">
                                                </td>
                                                <td>
                                                    <input type="number" v-model="item.espesor_minimo_anterior_me"
                                                        min="1" max="30" step="0.1">
                                                </td>
                                                <td>
                                                    <input type="number" v-model="item.años_ultima_inspeccion_me"
                                                        min="1" max="30" step="0.1">
                                                </td>
                                                <td>
                                                    <div v-if="indexPosTabla_me === k">
                                                        <input type="number"
                                                            v-model="item.cantidad_generatrices_linea_pdf_me" min="1"
                                                            max="30">
                                                    </div>
                                                    <div v-else>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered"
                                                style="display: block;max-height: 500px;border-bottom: none;border-right: none;">
                                                <tbody>
                                                    <tr v-for="(p) in parseInt(Tabla_me[indexPosTabla_me].cantidad_posiciones_me) + 1"
                                                        :key="p" @click="selectPosPos(p)">

                                                        <td style="min-width:60px;min-height:60px"
                                                            v-for="(g) in parseInt(Tabla_me[indexPosTabla_me].cantidad_generatrices_me) + 1"
                                                            :key="g" :bgcolor="colorLimiteTabla(p, g)"
                                                            @click="selectPosGeneratriz(g)">

                                                            <div v-if="p === 1 && g === 1">
                                                                &nbsp;
                                                            </div>
                                                            <div
                                                                v-else-if="p === 1 && g === parseInt(Tabla_me[indexPosTabla_me].cantidad_generatrices_me) + 1">
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ACCESORIO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            </div>
                                                            <!--accesorios -->
                                                            <div
                                                                v-else-if="g === parseInt(Tabla_me[indexPosTabla_me].cantidad_generatrices_me) + 1">
                                                                <div v-if="indexPosPos == p && indexPosGeneratriz == g">
                                                                    <!-- Input para accesorios cuando la celda está seleccionada para edición -->
                                                                    <input type="text"
                                                                        v-model="Tabla_me[indexPosTabla_me].mediciones[g - 1][p - 1]"
                                                                        maxlength="30">
                                                                </div>
                                                                <div v-else>
                                                            ...
                                                            <div
                                                                v-else-if="indexPosPos == p && indexPosGeneratriz == g">
                                                                <div v-if="p === 1 || g === 1">
                                                                    <input style="width:40px;"
                                                                        v-model="Tabla_me[indexPosTabla_me].mediciones[g - 1][p - 1]"
                                                                        maxlength="10" :ref="'refInputMediciones'"
                                                                        @keyup.enter="getFocus(g, Tabla_me[indexPosTabla_me].cantidad_generatrices_me, p, Tabla_me[indexPosTabla_me].cantidad_posiciones_me)">
                                                                </div>
                                                                <div v-else>
                                                                    <input style="width:40px;" type="text"
                                                                        v-model="Tabla_me[indexPosTabla_me].mediciones[g - 1][p - 1]"
                                                                        maxlength="4" :ref="'refInputMediciones'"
                                                                        @keyup.enter="getFocus(g, Tabla_me[indexPosTabla_me].cantidad_generatrices_me, p, Tabla_me[indexPosTabla_me].cantidad_posiciones_me)"
                                                                        step="0.1" max="99.9">
                                                                </div>
                                                            </div>
                                                            <div v-else>
                                                                ...
                                                                <div v-else>
                                                                    <span
                                                                        style="font-style: oblique; color: cadetblue;">
                                                                        {{ p - 1
                                                                        }}-{{ generatrices[g - 2].valor }} </span>
                                                                </div>
                ...
                <div class="box box-custom-enod">
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_indicaciones_us" :max_size="max_size"
                                    :path_inicial="path1_indicacion"
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path1_indicacion = $event"></subir-imagen>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_indicaciones_us" :max_size="max_size"
                                    ...
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path2_indicacion = $event"></subir-imagen>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_indicaciones_us" :max_size="max_size"
                                    ...
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path3_indicacion = $event"></subir-imagen>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <subir-imagen :ruta="ruta_indicaciones_us" :max_size="max_size"
                                    ...
                                    :tipos_archivo_soportados="tipos_archivo_soportados"
                                    :mostrar_formatos_soportados="true"
                                    @path="path4_indicacion = $event"></subir-imagen>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div v-if="mostrarInspeccionVisual" class="box box-custom-enod">
                    <div class="box-body">
                        ...
                        <div v-for="categoria in tablaInspeccion" :key="categoria.id" class="mb-4">
                ...
                <div class="box box-custom-enod">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <textarea v-model="observaciones" class="form-control noresize" rows="3" placeholder=""
        ...
        <create-referencias :index="index_referencias" :tabla="tabla" :inputsData="inputsData"
            @setReferencia="AddReferencia_us_pa"></create-referencias>
