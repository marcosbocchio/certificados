                            ...
                            <div class="col-md-3 col-md-offset-3" >
                                <div class="row">
                                    <div class="pull-right" style="margin: 0 15px 0 0">
                                        <button v-if="videoSelec" title="Editar" class="btn btn-enod btn-sm" @click="showVideoModal"><span class="fas fa-edit" aria-hidden="true" ></span></button>
                                        <button v-if="videoSelec" title="Eliminar " class="btn btn-danger btn-sm" @click="showVideoDeleteModal"><span class="fas fa-trash" aria-hidden="true"></span></button>
                                        <button class="btn btn-success btn-sm" @click="showNuevoVideoModal"><span class="fas fa-plus-circle" aria-hidden="true" ></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
