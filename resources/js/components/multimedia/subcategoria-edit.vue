                            ...
                            <div class="col-md-3 col-md-offset-3" >
                                <div class="row">
                                    <div class="pull-right" style="margin: 0 15px 0 0">
                                        <button v-if="subcategoriaSelec" title="Editar" class="btn btn-enod btn-sm" @click="showSubcatModal"><span class="fas fa-edit" aria-hidden="true" ></span></button>
                                        <button v-if="subcategoriaSelec" title="Eliminar " class="btn btn-danger btn-sm" @click="showSubcatDeleteModal"><span class="fas fa-trash" aria-hidden="true"></span></button>
                                        <button class="btn btn-success btn-sm" @click="shownuevaSubcatModal"><span class="fas fa-plus-circle" aria-hidden="true" ></span></button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div v-if="subcategoriaSelec">
        ...
        <div class="modal fade " tabindex="-1" role="dialog" id="modal-subcategoria" data-keyboard="false" data-backdrop="static" >
            <div class="modal-dialog modal-md" role="document">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-enod" form="subcategoriaForm">Guardar</button>
        ...
        <div class="modal fade " tabindex="-1" role="dialog" id="modal-subcategoria-nueva" data-keyboard="false" data-backdrop="static" >
            <div class="modal-dialog modal-md" role="document">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-enod" form="nuevaSubcategoriaForm">Guardar</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                </div>
                </div>
            </div>
        ...
        <div class="modal fade " tabindex="-1" role="dialog" id="modal-subcategoria-delete" data-keyboard="false" data-backdrop="static" >
            <div class="modal-dialog modal-md" role="document">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-enod-danger" form="subcategoriaDeleteForm">Aceptar</button>
