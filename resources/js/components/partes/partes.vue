            ...
            <form @submit.prevent="editmode ? Update() : Store()" method="post">
                    ...
                    <div class="box-body">
                        <div class="col-md-4s col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="checkbox" :disabled="hayInformesSeleccionados" id="checkbox_f"
                                    v-model="permitir_anteriores_sn" style="float:right">
                                <label for="tipo" style="float:right;margin-right: 5px;">Permitir Anteriores</label>
                                <div>
                                    <date-picker v-model="fecha" :disabled="hayInformesSeleccionados"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <v-select type="text" v-model="tipo_servicio" id="tipo_servicio"
                                    :options="['Diurno', 'Nocturno']"></v-select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="horario" class="form-control" maxlength="5" id="horario"
                                    v-on:keyup="FormatearHorario" placeholder="HH-HH">
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="km_inicial" class="form-control" id="km_inicial"
                                        min="0" step="0.1">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="km_final" class="form-control" id="km_final" min="0"
                                        step="0.1">
                                </div>
                            </div>
                            <div class="col-md-1">
                                        ...
                                        <table class="table table-hover table-striped table-condensed table-condensed">
                                            ...
                                            <tbody>
                                                <tr v-for="(item, k) in TablaVehiculos" :key="k">
                                                    ...
                                                    <td> {{ item.km_final }}</td>
                                                    <td style="text-align:center"> <a @click="RemoveVehiculo(k)">
                                                            <app-icon img="minus-circle" color="black"></app-icon> </a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                    ...
                    <div class="box-body">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <v-select multiple v-model="operadoresSelect" multiselect label="name"
                                    :options="operadores"></v-select>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                            ...
                                            <tr v-for="(item, k) in TablaResponsables" :key="k">
                                                ...
                                                <td @click="selectPosResponsabilidad(k)">
                                                    <div v-if="indexDetalle == k">
                                                        <input type="text"
                                                            v-model="TablaResponsables[k].responsabilidad"
                                                            maxlength="20">
                                                    </div>
                                                    <div v-else>
                                                ...
                                                <td style="text-align:center"> <a @click="RemoveResponsable(k)">
                                                        <app-icon img="minus-circle" color="black"></app-icon> </a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <table class="table table-hover table-striped table-condensed table-condensed">
                                    ...
                                    <tbody>
                                        <tr v-for="(informe, k) in informes" :key="k">
                                            <td>
                                                <input type="checkbox" id="informe_sel"
                                                    v-model="informes[k].informe_sel"
                                                    @click="selectPosTablaInformesSinParteDiario(k)"
                                                    @change="getInforme(k)"
                                                    :disabled="deshabilitarInformes(informe.fecha_formateada, informe.obra, informe.informe_sel) || isLoading">
                                            </td>
                ...
                <div class="box box-custom-enod">
                    <div class="box-header with-border">
                        ...
                        <div class="form-group">
                            <label
                                style="color:gray;display: inline-block;font-weight: lighter;font-style: oblique;text-align:right"
                                class="col-md-3 control-label"><span> Agregar Servicios Manualmente</span></label>
                            <div class="col-md-5">
                                <v-select v-model="servicio_manual" label="servicio_descripcion" :options="serviciosOt"
                                    id="serviciosOt"></v-select>
                            </div>
                            <div class="col-md-1">
                                ...
                                <table class="table table-hover table-striped table-bordered table-condensed">
                                    ...
                                    <tbody>
                                        <tr v-for="(item, k) in TablaServicios" :key="k"
                                            @click="selectPosTablaServicios(k)">
                                            ...
                                            <td v-if="item.visible">
                                                <div v-if="indexTablaServicios == k">
                                                    <input type="number" v-model.number="TablaServicios[k].cant_final"
                                                        maxlength="3" step="0.01" min="0"
                                                        @change="validarCantidad(TablaServicios, k, 'cant_final')">
                                                </div>
                                                <div v-else>
                                                    {{ item.cant_final }}
                                                </div>
                                            </td>
                                            <td style="text-align:center" v-if="item.visible"> <a
                                                    @click="RemoveTablaServicio(k)">
                                                    <app-icon img="minus-circle" color="black"></app-icon> </a></td>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <label
                                        style="color:gray;display: inline-block;font-weight: lighter;font-style: oblique;text-align:right"
                                        class="control-label"><span> Agregar costuras Manualmente</span></label>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model.number="costura_adicional" class="form-control"
                                        id="costura_adicional" maxlength="4" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <v-select v-model="pulgada_adicional" label="diametro"
                                        :options="diametros"></v-select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model.number="placa_adicional" class="form-control"
                                        id="placa_adicional" maxlength="4" step="0.1" min="0">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <v-select type="text" v-model="cm_adicional" label="codigo" id="cm"
                                        :options="medidas_placa" style="display: block" taggable
                                        @input="cambioMedida"></v-select>

                                </div>
                            </div>
                            <div class="col-sm-1">
                                <p>&nbsp;</p>
                                <button type="button" @click="AddCosturaAdicional()"
                                    title="Agregar Junta/Posición"><app-icon img="plus-circle"
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesRi" :key="k"
                                                @click="selectPosTablaInformesRi(k)">
                                                ...
                                                <td v-if="item.visible">
                                                    ...
                                                    <div v-if="indexTablaInformesRi == k">
                                                        <input type="number"
                                                            v-model.number="TablaInformesRi[k].costura_final"
                                                            maxlength="4"
                                                            @change="validarCantidad(TablaInformesRi, k, 'costura_final')">
                                                    </div>
                                                    <div v-else>
                                                        {{ item.costura_final }}
                                                    </div>
                                                ...
                                                <td v-if="item.visible">
                                                    <div v-if="indexTablaInformesRi == k">
                                                        <input type="number"
                                                            v-model.number="TablaInformesRi[k].placas_final"
                                                            maxlength="4" step="0.1" @input="RecalcularMetros('RI')"
                                                            @change="validarCantidad(TablaInformesRi, k, 'placas_final')">
                                                    </div>
                                                    <div v-else>
                                                        {{ item.placas_final }}
                                                    </div>
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" v-model="placas_repetidas" class="form-control"
                                        id="placas_repetidas" min="0">
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    <label for="placas_testigos">Placas Testigos Total *</label>
                                    <input type="number" v-model="placas_testigos" class="form-control"
                                        id="placas_testigos" min="0">
                                </div>
                            </div>
                ...
                <!--Informe RD -->
                <div v-show="TablaInformesRd.length">
                    <div class="box box-custom-enod">
                        <div class="box-header with-border">
                            <h3 class="box-title">Informes RD</h3>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesUs" :key="k"
                                                @click="selectPosTablaInformesUs(k)">
                                                ...
                                                <td v-if="item.visible">
                                                    <div v-if="(item.tecnica == 'ME')">
                                                        <div v-if="indexTablaInformesUs == k">
                                                            <input type="text" v-model="TablaInformesUs[k].pieza_final"
                                                                maxlength="10">
                                                        </div>
                                                        <div v-else>
                                                            {{ item.pieza_final }}
                                                ...
                                                <td v-if="item.visible">
                                                    <div v-if="indexTablaInformesUs == k">
                                                        <input type="number" v-model="TablaInformesUs[k].cm_final"
                                                            maxlength="4" @input="RecalcularMetros('US')">
                                                    </div>
                                                    <div v-else>
                                                        {{ item.cm_final }}
                                                    </div>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesCv" :key="k">
                                                ...
                                                <td> N/A </td>
                                                <td style="text-align:center"> <a @click="RemoveTablaCv(k)"> <app-icon
                                                            img="minus-circle" color="black"></app-icon> </a></td>
                                            </tr>
                                            <tr v-for="fila in 4">
                                                <td colspan="6" style="background: #FFFFFF"> &nbsp;</td>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesPmi" :key="k">
                                                ...
                                                <td> N/A </td>
                                                <td style="text-align:center"> <a @click="RemoveTablaPmi(k)"> <app-icon
                                                            img="minus-circle" color="black"></app-icon> </a></td>
                                            </tr>
                                            <tr v-for="fila in 4">
                                                <td colspan="6" style="background: #FFFFFF"> &nbsp;</td>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesRg" :key="k">
                                                ...
                                                <td> N/A </td>
                                                <td style="text-align:center"> <a @click="RemoveTablaRg(k)"> <app-icon
                                                            img="minus-circle" color="black"></app-icon> </a></td>
                                            </tr>
                                            <tr v-for="fila in 4">
                                                <td colspan="6" style="background: #FFFFFF"> &nbsp;</td>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesDz" :key="k">
                                                ...
                                                <td> N/A </td>
                                                <td style="text-align:center"> <a @click="RemoveTablaDz(k)"> <app-icon
                                                            img="minus-circle" color="black"></app-icon> </a></td>
                                            </tr>
                                            <tr v-for="fila in 4">
                                                <td colspan="6" style="background: #FFFFFF"> &nbsp;</td>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, k) in TablaInformesTt" :key="k">
                                                ...
                                                <td> N/A </td>
                                                <td style="text-align:center"> <a @click="RemoveTablaTt(k)"> <app-icon
                                                            img="minus-circle" color="black"></app-icon> </a></td>
                                            </tr>
                                            <tr v-for="fila in 4">
                                                <td colspan="6" style="background: #FFFFFF"> &nbsp;</td>
                                            ...
                                            <tr v-for="(item, k) in TablaInformesImportados" :key="k"
                                                ...
                                                <td v-if="item.visible && itemMetodo == item.metodo">
                                                    <div
                                                        ...
                                                        <input type="text"
                                                            v-model="TablaInformesImportados[k].observaciones_final"
                                                ...
                                                <td style="text-align:center"
                                                    v-if="item.visible && itemMetodo == item.metodo"> <a
                                                        @click="RemoveTablaInformeiImportable(k)"> <app-icon
                                                            img="minus-circle" color="black"></app-icon> </a></td>
...
export default {
    ...
    computed: {
        ...
        hayInformesSeleccionados() {
            return this.informes.some(inf => inf.informe_sel);
        }
    },
    ...
    methods: {
        ...
        selectPosTablaInformesRd: function (index) {

            this.indexTablaInformesRd = index;
        ...
        getInformesPendientesParte: function () {
            ...
            if (this.fecha) {
                ...
                var urlRegistros = 'informes/ot/' + this.otdata.id + '/obra/' + obraInformes + '/fecha/' + fecha + '/permitir/' + permitirAnteriores + '/pendientes_parte_diario' + '?api_token=' + Laravel.user.api_token;
                this.isLoading = true;
                axios.get(urlRegistros).then(response => {
        ...
        RemoveTablaRd(index) {
            ...
            this.TablaInformesRd.splice(index, 1);
            ...
            if (this.informes[index].informe_sel) {
                ...
                if (this.informes[index].importable_sn) {
                    ...
                    switch (this.informes[index].metodo) {
                        ...
                        case 'RD': await this.getInformeRD(this.informes[index].id, index); break;
                ...
                if (this.informes[index].importable_sn) {
                    ...
                    for (var i = 0; i < this.TablaInformesRd.length; i++) {
                        if (this.TablaInformesRd[i].id == id) {
                            this.TablaInformesRd.splice(i, 1);
                            i--;
                        }
                    }
        ...
        async getServiciosInformes(informe_id, importado_sn) {
            ...
            informe_servicios.forEach(function (item) {
                ...
                if (this.TablaServicios.findIndex(elemento => elemento.servicio_descripcion == item.servicio_descripcion) != -1 && this.TablaServicios[this.TablaServicios.findIndex(elemento => elemento.servicio_descripcion == item.servicio_descripcion)].visible) {
                    ...
                    } else if (item.unidad_medida == 'Metro' && item.metodo == 'RD') {

                        let metros = this.CalcularMetrosRD(item);
                        this.TablaServicios[this.TablaServicios.findIndex(elemento => elemento.servicio_descripcion == item.servicio_descripcion)].cant_final = metros;
                    ...
                    if (item.unidad_medida == 'Metro') {
                        ...
                        } else if (item.metodo == 'RD') {
                            cantidad = this.CalcularMetrosRD(item)
        ...
        RecalcularMetros(metodo) {
            ...
            if (this.TablaServicios.findIndex(elemento => elemento.unidad_medida == 'Metro' && elemento.metodo == metodo) != -1) {
                ...
                switch (metodo) {
                    ...
                    case 'RD':
                        this.TablaServicios[this.TablaServicios.findIndex(elemento => elemento.unidad_medida == 'Metro' && elemento.metodo == 'RD')].cant_final = this.CalcularMetrosRD();
                        break;
        ...
        CalcularMetrosRD: function () {

            let metros = 0;
            let cms = 0;
            this.TablaInformesRd.forEach(function (item) {
        ...
        Store: function () {
            ...
            axios({
                ...
                data: {
                    ...
                    'informes_rd': this.TablaInformesRd,
