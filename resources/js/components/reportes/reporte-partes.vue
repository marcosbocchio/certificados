<template>
    <div class="row">
                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item pointer">
                            ...
                            <v-select v-show="selCliente" v-model="cliente" label="nombre_fantasia"
                                :options="clientesOperador" @input="CambioCliente()"></v-select>
                        ...
                        <li class="list-group-item pointer">
                            ...
                            <v-select v-show="selOt" v-model="ot" label="numero" :options="ots"
                        ...
                        <li class="list-group-item pointer">
                            ...
                            <v-select v-show="selObra" v-model="obra" label="obra" :options="obras"
                                @input="CambioObra()"></v-select>
                        </li>
                        <li class="list-group-item pointer">
                            ...
                            <v-select v-show="selGenerador" v-model="generador" label="name" :options="users_empresa"
                                @input="selGenerador = !selGenerador"></v-select>

                        </li>
                        <li class="list-group-item pointer">
                            <span class="titulo-li">Solo sin certificado</span> <input class="checkbox-right"
                                type="checkbox" v-model="filtrado">
                        </li>
                        <li class="list-fecha list-group-item pointer">
                            <div class="row">
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    <date-picker v-model="fecha_desde" value-type="YYYY-MM-DD" format="DD-MM-YYYY"
                                        placeholder="Desde"></date-picker>
                                </div>
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    <date-picker v-model="fecha_hasta" value-type="YYYY-MM-DD" format="DD-MM-YYYY"
        ...
        <div class="col-md-9">
                                            ...
                                            <table class="table table-striped table-condensed">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <th style="text-align:center" class="col-md-1">N°Certificado
                                                        </th>
                                                    </tr>
                                                    <tr v-for="(item, k) in tablaPartes.data" :key="k">
                                                        <td> {{ item.fecha }}</td>
                                                        <td style="text-align:center">
                                                            <a :href="'/pdf/parte/' + item.numero + '/final'"
                                                                target="_blank" title="Informe"><span>{{
                                                                    item.numero_formateado }}</span></a>
                                                        </td>
                                                        ...
                                                        <td style="text-align:center">
                                                            <a :href="'/pdf/certificado/' + item.certificado + '/final'"
                                                                target="_blank" title="Informe"><span>{{
                                                                    item.certificado_formateado }}</span></a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
            ...
            <pagination :data="tablaPartes" @pagination-change-page="Buscar" :limit="3"><span slot="prev-nav">&lt;
                    Previous</span>
