...
class ClienteRequest extends FormRequest
{
    ...
    public function attributes()
    {
            return [
                ...
                'direccion'           => 'dirección',
                'tel'                 => 'teléfono',
                'contacto1.nombre'    => 'nombre del contacto1',
                'contacto1.cargo'     => 'cargo del contacto1',
                'contacto1.email'     => 'email del contacto1',
                'contacto1.tel'       => 'teléfono del contacto1',
                'contacto2.nombre'    => 'nombre del contacto2',
                'contacto2.cargo'     => 'cargo del contacto2',
                'contacto2.email'     => 'email del contacto2',
                'contacto2.tel'       => 'teléfono del contacto2',
                'contacto3.nombre'    => 'nombre del contacto3',
                'contacto3.cargo'     => 'cargo del contacto3',
                'contacto3.email'     => 'email del contacto3',
                'contacto3.tel'       => 'teléfono del contacto3',
            ];
