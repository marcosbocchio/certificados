...
class InformeRdRequest extends FormRequest
{
    ...
    if($this->gasoducto_sn == false){
     ...
     $validacion = [
                ...
                'medida.codigo'             => 'nullable',
                'ot_tipo_soldadura'         => 'required',
                'diametro'                  => 'required',
                'tecnica'                   => 'required',
                'interno_equipo'            => 'required',
                'tipo_pelicula'             => 'nullable',
                'procedimiento'             => 'required',
                'pos_ant'                   => 'nullable|numeric|between:0,999.99',
                'pos_pos'                   => 'nullable|numeric|between:0,999.99',
                'pitch'                     => 'nullable|numeric|between:0,99999.99',
                'srb_dwi'                   => 'nullable|numeric|between:0,99999.99',
                'lado'                      => 'required|Max:6',
                'ici'                       => 'required',
                'norma_evaluacion'          => 'required',
                'norma_ensayo'              => 'required',
                'dimension_detector'        => 'nullable',
                'tipo_centellador'          => 'nullable',
                'filtro_aplicado_rd'        => 'nullable',
                'software_adquisicion_rd'   => 'nullable',
                'actividad'                 => 'Max:10',
