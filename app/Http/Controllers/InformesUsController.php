...
class InformesUsController extends Controller
{
    ...
    public function create($ot_id)
    {
        ...
        return view('informes.us.index', compact(
            'ot',
            'metodo',
            'user',
            'header_titulo',
    ...
    public function edit($ot_id, $id)
    {
        ...
        return view('informes.us.edit', compact(
            'ot',
            'metodo',
            'user',
            'informe',
    ...
    public function getCalibraciones($informe_us_id)
    {
        ...
        $calibraciones =  CalibracionesUs::where('informe_us_id', $informe_us_id)
    ...
    public function getComponente($informe_us_id)
    {
        ...
        $componente =  ComponenteUsMe::where('informe_us_id', $informe_us_id)
            ->with('norma')
            ->with('material')
            ->with('materiales')
            ->with('fluido')
    ...
    public function getInspeccionVisual($informe_us_id)
    {
        ...
        $inspeccion_visual =  RespuestasInforme::where('informe_id', $informe_us_id)
            ->get();
